        ...
        */
        function processRetrieveResultEntitySearchData(results) {
            if (results['error'] == 'null') {
                ...
                document_handler_form_entity_search_list = results['data']['document_handler_form_entity_search_list'];

                document.getElementById('document_handler_form_entity_search_total_result').innerHTML = document_handler_form_entity_search_list.length + ' found';
                ...
                switch (document_handler_form_current_search_target) {
                    ...
                    case 'contact_from_search':
                        document_handler_form_contact_from_search_list = results['data']['document_handler_form_entity_search_list'];
                        break;
                    case 'contact_to_search':
                        document_handler_form_contact_to_search_list = results['data']['document_handler_form_entity_search_list'];
                        break;
                }
            } else {
                console.log('processRetrieveResultEntitySearchData > results:');
        ...
        function retrieveEntitySearchData() {
            ...
            request_data = {
                ...
                "username":login_user_info['username'], 
                "password":login_user_info['password'], 
                "entity_search_word":document.getElementById('document_handler_form_entity_search_word').value 
            };
