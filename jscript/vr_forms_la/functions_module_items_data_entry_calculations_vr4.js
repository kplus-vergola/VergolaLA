        function assignVrDimensionsToVrFormItemsDataEntryVr4() {
            var c1 = 0;
            var c2 = 0;
                ...
                switch (vr_form_items_data_entry[c1]['vr_item_config_internal_ref_name']) {
                    ...
                    case 'gutter_lining':
                        gutter_lining_related_items = [
                            'gutter_narrow_bay_1', 'gutter_narrow_bay_2', 'gutter_narrow_bay_3', 
                            'gutter_wide_bay_1', 'gutter_wide_bay_2', 'gutter_wide_bay_3', 
                    ...
                    case 'vergola_system_louvre_bay_3':
                        total_louvre = Math.round(vr_lengths_in_value_for_calculation[2] / minimum_inch_per_louvre);
                        total_endcap = total_louvre * 2;
