        function processVrFormQueriesValueForGableType() {
            ...
            var rafter_length_feet_value = 0.0;
            var rafter_length_inch_value = 0.0;
            var temp_array = [];

            if (document.getElementById('vr_run_feet_form_query').value.length > 0) {
                run_feet_value = document.getElementById('vr_run_feet_form_query').value;
            }
            if (document.getElementById('vr_run_inch_form_query').value.length > 0) {
                run_inch_value = document.getElementById('vr_run_inch_form_query').value;
            }
            if (document.getElementById('vr_rise_feet_form_query').value.length > 0) {
                rise_feet_value = document.getElementById('vr_rise_feet_form_query').value;
            }
            if (document.getElementById('vr_rise_inch_form_query').value.length > 0) {
                rise_inch_value = document.getElementById('vr_rise_inch_form_query').value;
            }

            run_value = run_feet_value + '\'' + run_inch_value;
            rise_value = rise_feet_value + '\'' + rise_inch_value;
            rafter_length_value = formulaGetRafterLength(run_value, rise_value);
            temp_array = rafter_length_value.split('\'');
            rafter_length_feet_value = temp_array[0];
            rafter_length_inch_value = temp_array[1];

            document.getElementById('vr_length_feet_form_query_0').value = rafter_length_feet_value;
            document.getElementById('vr_length_inch_form_query_0').value = rafter_length_inch_value;
            document.getElementById('vr_length_feet_form_query_1').value = rafter_length_feet_value;
            document.getElementById('vr_length_inch_form_query_1').value = rafter_length_inch_value;
        }
        ...
        function copyVrFormQueriesInfoFormValue() {
            ...
            for (c1 = 0; c1 < parseInt(vr_type_info['number_of_bay']); c1++) {
                if (document.getElementById('vr_length_feet_form_query_' + c1) && 
                    document.getElementById('vr_length_inch_form_query_' + c1)) {
                    vr_form_queries_info['vr_length_info']['vr_lengths_feet'][c1] = document.getElementById('vr_length_feet_form_query_' + c1).value;
                    vr_form_queries_info['vr_length_info']['vr_lengths_inch'][c1] = document.getElementById('vr_length_inch_form_query_' + c1).value;
                }
            }
        ...
        function processVrDimensionFormQueries(process_option) {
            ...
            var template_vr_run_form_query_body = '' +  
                    '<td class="vr_table_body_3">' + 
                        '<input type="text" class="vr_form_field_textbox_feet_1" id="vr_run_feet_form_query" name="vr_run_feet_form_query" value="" placeholder="Feet" onchange="processVrFormQueriesValueForGableType()">' + 
                        '<input type="text" class="vr_form_field_textbox_inch_1" id="vr_run_inch_form_query" name="vr_run_inch_form_query" value="" placeholder="Inch" onchange="processVrFormQueriesValueForGableType()">' + 
                    '</td>';
            var template_vr_rise_form_query_body = '' + 
                    '<td class="vr_table_body_3">' + 
                        '<input type="text" class="vr_form_field_textbox_feet_1" id="vr_rise_feet_form_query" name="vr_rise_feet_form_query" value="" placeholder="Feet" onchange="processVrFormQueriesValueForGableType()">' + 
                        '<input type="text" class="vr_form_field_textbox_inch_1" id="vr_rise_inch_form_query" name="vr_rise_inch_form_query" value="" placeholder="Inch" onchange="processVrFormQueriesValueForGableType()">' + 
                    '</td>';
            var template_vr_length_form_query_body = '' + 
                    '<td class="vr_table_body_3">' + 
                        '<input type="text" class="vr_form_field_textbox_feet_1" id="vr_length_feet_form_query_[INDEX_NUMBER]" name="vr_length_feet_form_query_[INDEX_NUMBER]" placeholder="Feet" value="" onchange="calculateVrFormItemsDataEntryValues(1)" />' + 
                        '<input type="text" class="vr_form_field_textbox_inch_1" id="vr_length_inch_form_query_[INDEX_NUMBER]" name="vr_length_inch_form_query_[INDEX_NUMBER]" placeholder="Inch" value="" onchange="calculateVrFormItemsDataEntryValues(1)" />' + 
                    '</td>';
            var template_vr_width_form_query_body = '' + 
                    '<td class="vr_table_body_3">' + 
                        '<input type="text" class="vr_form_field_textbox_feet_1" id="vr_width_feet_form_query" name="vr_width_feet_form_query" value="" placeholder="Feet" onchange="calculateVrFormItemsDataEntryValues(1)" />' + 
                        '<input type="text" class="vr_form_field_textbox_inch_1" id="vr_width_inch_form_query" name="vr_width_inch_form_query" value="" placeholder="Inch" onchange="calculateVrFormItemsDataEntryValues(1)" />' + 
                    '</td>';
