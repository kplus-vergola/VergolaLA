...
{	
    ...
    else {mysql_query("INSERT INTO ver_chronoforms_data_letters_vic (clientid, template_name, datecreated, template_content) 
		 VALUES ('$template_clientid','$template_title', '$current_date', '$template_content')");}
...
<table class="template_tbl" cellspacing="0" cellpadding="0">
	<tr>
		...
		<?php if (fnmatch("*Single Bay VR1",$VergolaType)){ ?>
			<td width="120">
			 	 <b>Length </b>
			</td>
			<td width="120">
	...
	<tr>
		<td> 
			 <?php echo $project['fquotedate']; ?>
		</td>
		<td>
		 	<?php echo $project['project_name']; ?>
		</td>
		<td> 
			 <?php echo $quoteInfo['framework_type']; ?>
		</td>
		<td>
		 	<?php echo $quoteInfo['framework']; ?>
		</td>
		<?php if (fnmatch("*Single Bay VR1",$VergolaType)){ ?>
			<td>
			 	<?php echo $ReLen; ?>
...
<table class="" border="1" cellspacing="0" style="border-collapse:collapse;font-size:9pt; " >
	...
	//$resultpurchase = mysql_query ($sqlpurchase) or die ('request "Could not execute SQL query" '.$sqlpurchase);
		...
		// $sql = " SELECT   *  FROM ver_chronoforms_data_contract_bom_vic AS i JOIN ver_chronoforms_data_inventory_vic AS inv ON inv.inventoryid=i.inventoryid WHERE i.projectid = '{$projectid}'     ";
...
?>
	...
	echo "<tr> <th colspan='8' style='text-align:center;'><b>Framework</b></th> </tr>"; 
	...
	echo "<tr> <th colspan='8' style='text-align:center;'><b>Fittings</b></th> </tr>"; 
	while ($row = mysql_fetch_assoc($item_result)){ 
	...
	echo "<tr> <th colspan='8' style='text-align:center;'><b>Flashings</b></th> </tr>"; 
	while ($row = mysql_fetch_assoc($item_result)){ 
	...
	echo "<tr> <th colspan='8' style='text-align:center;'><b>Downpipe</b></th> </tr>"; 
	while ($row = mysql_fetch_assoc($item_result)){ 
	...
	echo "<tr> <th colspan='8' style='text-align:center;'><b>Vergola</b></th> </tr>"; 
	while ($row = mysql_fetch_assoc($item_result)){ 
	...
	echo "<tr> <th colspan='8' style='text-align:center;'><b>Miscellaneous</b></th> </tr>"; 
	while ($row = mysql_fetch_assoc($item_result)){ 
	...
	echo "<tr> <th colspan='8' style='text-align:center;'><b>Extras</b></th> </tr>"; 
	while ($row = mysql_fetch_assoc($item_result)){ 
	...
	echo "<tr> <th colspan='8' style='text-align:center;'><b>Disbursements</b></th> </tr>"; 
	while ($row = mysql_fetch_assoc($item_result)){ 
...
<table class="template_tbl" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td>
		 	 &#36;<?php echo $project['payment_deposit']; ?>
		</td>
		<td> 
			 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
		</td>
		...
		<td>
		 	&#36;<?php echo $project['subtotal_vergola']; ?>
		</td> 
	</tr>

	<tr>
		<td colspan="2"> 
			Sales COmmision Payment Schedule
		</td>
		...
		<td>
		 	&#36;<?php echo $project['payment_progress']; ?>
		</td>
		<td> 
			 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
		</td>
		...
		<td> 
			Disbursement Sub Total
		</td>
		<td>
		 	&#36;<?php echo $project['subtotal_disbursement']; ?>
		</td>
	...
	<tr>
		...
		<td>
		 	 &#36;<?php echo $project['payment_final']; ?>
		</td>
		<td> 
			 &nbsp;
		</td>
		...
		<td>
		 	 &#36;<?php echo $project['total_cost_gst']; ?>
		</td>
	...
	<tr>
		...
		<td>
		 	 &#36;<?php echo $project['total_rrp_gst']; ?>
		</td>
	...
	<tr>
		...
		<td>
		  &#36;<?php echo $project['install_comm_cost']; ?>
		</td>
		<td> 
			 &nbsp;
		</td>
...
<input type="submit" class="btn" name="add" id="add" value="Download PDF"> <input class="btn" type="button" value="Close" onClick="window.opener=null; window.close(); return false;">
...
function generateHtmlReport($projectid,$title){
	...
	$thml = '<div style="font-family:Arial, Helvetica, sans-serif; width:700px;  font-size: 10pt;">
...
<table class="" border="1" cellspacing="0" style="border-collapse:collapse;font-size:9pt; " >
	...
	//downpipe 		
	$$html .= "SELECT  i.inventoryid, q.* FROM ver_chronoforms_data_quote_vic AS q LEFT JOIN ver_chronoforms_data_inventory_vic AS i ON i.inventoryid=q.inventoryid WHERE q.projectid='{$projectid}'  AND i.section='Downpipe'  ";
