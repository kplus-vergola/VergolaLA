...
//error_log($resultm, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
...
if($VergolaType == "Double Bay" || $VergolaType == "Double Bay - Drop-In" || $VergolaType == "Double Bay VR2" || $VergolaType == "Double Bay VR3" || $VergolaType == "Double Bay VR3 - Gutter" || $VergolaType == "Double Bay VR2 - Drop-In" || $VergolaType == "Double Bay VR3 - Drop-In" || $VergolaType == "Double Bay VR3 - Gutter - Drop-In"  ){
	...
	while ($retrievem = mysql_fetch_array($resultm)){
		...
		$k++;
		//error_log("DOUBLE BAY width: ".$_ReWid, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log'); 
	}	
	$numBay = 2;
...
//error_log(print_r($retrieveq,true), 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
...
// }else 
//error_log("Framewor: ".$retrieveq['framework'], 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log'); 
$is_drop_in = 0;
...
//error_log(print_r($postColumn,true), 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log'); 
