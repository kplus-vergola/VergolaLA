...
if(isset($_POST['delete-drawing'])) {
 ...
 <div id="sales" class="tab_content"> 
    ...
    <div class="modification-button-holder"> 
      ...
      <a id="template_link" href="<?php echo JURI::base().'images/template/Sales-Contract-Template-5-2-24.docx'; ?> " download style="margin-right:5px;">Sales Contract - Residential</a>
