...
{   
    $BuildID1 = $_POST['builderid1'];
    $BuildSuburbID1 = $_POST['bsuburbid1'];
  ...
  <div id="tabs_content_container"> 
    ...
    <!-- ----------------------------------------------------- Builder 1 Details ---------------------------------------------------------- -->
        ...
        <label class="input"><span id="bnameid1">Company Name</span>
          <input type="text" value="<?php echo $BuildName; ?>" id="build_name1" name="builder_name1" onkeypress="bcompanychange1();">
        </label>
    ...
    <!-- ----------------------------------------------------- Builder 2 Details ---------------------------------------------------------- -->
         ...
         <label class="input"><span id="bnameid2">Company Name</span>
          <input type="text" value="<?php echo $BuildName; ?>" id="build_name2" name="builder_name2" onkeypress="bcompanychange2();">
        </label>
    ...
    <!-- ----------------------------------------------------- Builder 3 Details ---------------------------------------------------------- -->
        ...
        <label class="input"><span id="bnameid3">Company Name</span>
          <input type="text" value="<?php echo $BuildName; ?>" id="build_name3" name="builder_name3" onkeypress="bcompanychange3();">
        </label>
    ...
    <label class="input"><span id="bnameid4">Company Name</span>
          <input type="text" value="<?php echo $BuildName; ?>" id="build_name4" name="builder_name4" onkeypress="bcompanychange4();">
        </label>
    ...
    <label class="input"><span id="bnameid5">Company Name</span>
          <input type="text" value="<?php echo $BuildName; ?>" id="build_name5" name="builder_name5" onkeypress="bcompanychange5();">
        </label>
    ...
    <label class="input"><span id="bnameid6">Company Name</span>
          <input type="text" value="<?php echo $BuildName; ?>" id="build_name6" name="builder_name6" onkeypress="bcompanychange6();">
        </label>
...
<!-- --------------------------------------------------------- End of Builder Tabs ----------------------------------------------- -->
  ...
  <div id="tabs_wrapper" class="info-tab">
    ...
    ?>
     ...
     <label class='' style="color:#222; display: inline-table;"><span></span>  
    <label class='input'><span>Consultant</span><select class='rep-list' id='replist' name='replist' onchange='javascript:SelectChangedRep();'><option></option>
    <?php
            $usergroup = 'Victoria Users';
            //$querysub2="SELECT id, name FROM ver_users WHERE usertype LIKE ('$usergroup') ORDER BY name ASC";
            $querysub2="SELECT id, name, RepID  FROM ver_users WHERE (block=0 AND usertype LIKE ('$usergroup')) AND id IN (SELECT user_id FROM ver_user_usergroup_map WHERE group_id=27 || group_id=9) ORDER BY name ASC";
    ...
    function SelectChangedRep()
    {
        ...
        ?>
            ...
            <label class='input'><span>Lead Source</span><select class='lead-list' id='leadlist' name='leadlist' onchange='javascript:SelectChangedLead();'><option></option>
            <?php
