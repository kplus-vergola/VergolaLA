    ...
    <div id="contracts" class="tab_content" style="display: block;">
        ...
        <div id="drawing-tbl">
          <table id="tbl-pdf">
            ...
            <?php 
             error_log("SELECT * FROM ver_chronoforms_data_letters_vic  WHERE template_name LIKE 'Sales Contract - Builder%' OR template_name LIKE 'Client Authority%' OR template_name LIKE 'Contract Variation Letter%'   ORDER BY datecreated DESC", 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
