...
<html>
    <head>
        ...
        <script src="<?php echo $config['path']['base_url'] . 'jscript/document_handler/functions_module_document_handler_enquiry.js'; ?>" type="text/javascript"></script>
        ...
        include 'config_module_document_handler.php';
        ?>
    </head>
        ...
        <div id="document_handler_form_container_area" class="document_handler_form_container_area_1">
            <div id="document_handler_form_entity_area" class="document_handler_form_entity_area_1">
                <table class="document_handler_form_table_1">
                    <tr>
                        <td colspan="2" class="document_handler_form_title_1">ENTITY</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <select multiple size="10" class="document_handler_form_selectbox_1" id="document_handler_form_entity_list" name="document_handler_form_entity_list" onchange="processEnquirySelectionChange()">
                            </select >
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="document_handler_form_field_name_1">Details: </td>
                        <td>
                            <textarea class="document_handler_form_textarea_1" id="document_handler_form_entity_details" name="document_handler_form_entity_details"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td class="document_handler_form_field_name_1">Date Lodged: </td>
                        <td>
                            <input type="text" class="document_handler_form_textbox_1" id="document_handler_form_entity_date_lodged" name="document_handler_form_entity_date_lodged" value="" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" class="document_handler_form_row_separator_1">&nbsp;</td>
                    ...
                    <tr>
                        <td colspan="2">
                            <input type="button" class="document_handler_form_button_1" id="document_handler_form_entity_button_new" name="document_handler_form_entity_button_new" value="New" />
                            <input type="button" class="document_handler_form_button_1" id="document_handler_form_entity_button_save" name="document_handler_form_entity_button_save" value="Save" />
                        </td>
                    </tr>
                    -->
                </table>
            ...
            <div id="document_handler_form_folder_area" class="document_handler_form_folder_area_1">
                <table class="document_handler_form_table_1">
                    <tr>
                        <td colspan="2" class="document_handler_form_title_1">FOLDER</td>
                    </tr>
                    <tr>
                        <td colspan="2" class="document_handler_form_row_separator_1">&nbsp;</td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <select multiple size="10" class="document_handler_form_selectbox_1" id="document_handler_form_enquiry_folder_list" name="document_handler_form_enquiry_folder_list" onchange="processEnquiryFolderSelectionChange()">
                            </select >
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="document_handler_form_field_name_1">Linked to Entity(s): </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="2">
                            <input type="button" class="document_handler_form_button_1" id="document_handler_form_folder_button_new" name="document_handler_form_folder_button_new" value="New" onclick="clearEnquiryFolderPropertiesToFields()" />
                            ...
                            <input type="button" class="document_handler_form_button_1" id="document_handler_form_folder_button_refresh" name="document_handler_form_folder_button_refresh" value="Refresh" onclick="refreshEnquiryFolderPropertiesToFields()" />
            ...
            <div id="document_handler_form_file_area" class="document_handler_form_file_area_1">
                <table class="document_handler_form_table_1">
                    <tr>
                        <td colspan="2" class="document_handler_form_title_1">FILE</td>
                    </tr>
                    <tr>
                        <td colspan="2" class="document_handler_form_row_separator_1">&nbsp;</td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <select multiple size="10" class="document_handler_form_selectbox_1" id="document_handler_form_folder_file_list" name="document_handler_form_folder_file_list" onchange="processEnquiryFileSelectionChange()">
                            </select >
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="document_handler_form_textbox_1" id="document_handler_form_file_content_category" name="document_handler_form_file_content_category" value="" />
                        </td>
                    </tr>
                    <tr>
                        <td class="document_handler_form_field_name_1">Linked to Folder(s): </td>
                        <td>
                            <div class="document_handler_form_divselect_1" id="document_handler_form_file_folder_divselectbox">
                                <!--
                                <input type="checkbox" class="document_handler_form_checkbox_1" id="document_handler_form_file_folder_link_1" name="document_handler_form_file_folder_link_1" value="" />&nbsp;file folder 1<br />
                                <input type="checkbox" class="document_handler_form_checkbox_1" id="document_handler_form_file_folder_link_2" name="document_handler_form_file_folder_link_2" value="" />&nbsp;file folder 2<br />
                                <input type="checkbox" class="document_handler_form_checkbox_1" id="document_handler_form_file_folder_link_3" name="document_handler_form_file_folder_link_3" value="" />&nbsp;file folder 3<br />
                                <input type="checkbox" class="document_handler_form_checkbox_1" id="document_handler_form_file_folder_link_4" name="document_handler_form_file_folder_link_4" value="" />&nbsp;file folder 4<br />
                                <input type="checkbox" class="document_handler_form_checkbox_1" id="document_handler_form_file_folder_link_5" name="document_handler_form_file_folder_link_5" value="" />&nbsp;file folder 5<br />
                                <input type="checkbox" class="document_handler_form_checkbox_1" id="document_handler_form_file_folder_link_6" name="document_handler_form_file_folder_link_6" value="" />&nbsp;file folder 6<br />
                                <input type="checkbox" class="document_handler_form_checkbox_1" id="document_handler_form_file_folder_link_7" name="document_handler_form_file_folder_link_7" value="" />&nbsp;file folder 7<br />
                                -->
                            </div>
                    ...
                    <tr>
                        <td colspan="2">
                            <input type="button" class="document_handler_form_button_1" id="document_handler_form_file_button_new" name="document_handler_form_file_button_new" value="New" onclick="clearFolderFilePropertiesToFields()" />
                            <input type="button" class="document_handler_form_button_1" id="document_handler_form_file_button_save" name="document_handler_form_file_button_save" value="Save" onclick="saveDocumentHandlerFormFileDataEntry()" />
                            <input type="button" class="document_handler_form_button_1" id="document_handler_form_file_button_download_file" name="document_handler_form_file_button_download_file" value="Download" onclick="downloadDocumentHandlerFormFile()" />
                            <input type="button" class="document_handler_form_button_1" id="document_handler_form_file_button_refresh" name="document_handler_form_file_button_refresh" value="Refresh" onclick="refreshEnquiryFilePropertiesToFields()" />
                            <input type="button" class="document_handler_form_button_1" id="document_handler_form_file_button_delete" name="document_handler_form_file_button_delete" value="Delete" onclick="deleteDocumentHandlerFormFileDataEntry()" />
                            <input type="button" class="document_handler_form_button_2" id="document_handler_form_file_button_download_msword_plugin" name="document_handler_form_file_button_download_msword_plugin" value="Download MS-Word Plugin" onclick="downloadDocumentHandlerFormMsWordPlugin()" />
                        </td>
                    </tr>
                </table>
            </div>
