        ...
        <div id="document_handler_form_container_area" class="document_handler_form_container_area_1">
            <div id="document_handler_form_entity_area" class="document_handler_form_entity_area_1">
                <table class="document_handler_form_table_1">
                    <tr>
                        <td colspan="2" class="document_handler_form_title_1" id="document_handler_form_entity_area_main_title">ENTITY</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" class="document_handler_form_field_name_1">
                            <select multiple size="10" class="document_handler_form_selectbox_1" id="document_handler_form_entity_list" name="document_handler_form_entity_list" onchange="processEntitySelectionChange()">
                            </select >
                        </td>
                    </tr>
                    <tr>
            ...
            <div id="document_handler_form_folder_area" class="document_handler_form_folder_area_1">
                <table class="document_handler_form_table_1">
                    <tr>
                        <td colspan="2" class="document_handler_form_title_1" id="document_handler_form_folder_area_main_title">FOLDER</td>
                    </tr>
                    <tr>
                        <td colspan="2" class="document_handler_form_row_separator_1">&nbsp;</td>
                    </tr>
                    <tr>
                        <td colspan="2" class="document_handler_form_field_name_1">
                            <select multiple size="10" class="document_handler_form_selectbox_1" id="document_handler_form_entity_folder_list" name="document_handler_form_entity_folder_list" onchange="processEntityFolderSelectionChange()">
                            </select >
                        </td>
                    </tr>
                    <tr>
            ...
            <div id="document_handler_form_file_area" class="document_handler_form_file_area_1">
                <table class="document_handler_form_table_1">
                    <tr>
                        <td colspan="2" class="document_handler_form_title_1" id="document_handler_form_file_area_main_title">FILE</td>
                    </tr>
                    <tr>
                        <td colspan="2" class="document_handler_form_row_separator_1" id="document_handler_form_file_area_main_title_separator">&nbsp;</td>
                    </tr>
                    <tr>
                        <td colspan="2" class="document_handler_form_field_name_1">
                    ...
                    <tr id="document_handler_form_file_content_category_row">
                        ...
                        <td class="document_handler_form_field_name_1">
                            <!--
                            <input type="text" class="document_handler_form_textbox_1" id="document_handler_form_file_status" name="document_handler_form_file_status" value="" />
                            -->
                    ...
                    <tr>
                        <td colspan="2" class="document_handler_form_field_name_1">
                            ...
                            <input type="button" class="document_handler_form_button_1" id="document_handler_form_file_button_download_file" name="document_handler_form_file_button_download_file" value="Download" onclick="downloadDocumentHandlerFormFile('dl')" />
                            <input type="button" class="document_handler_form_button_1" id="document_handler_form_file_button_download_file" name="document_handler_form_file_button_download_file" value="Download(Data Merge)" onclick="downloadDocumentHandlerFormFile('dl_dm')" />
                            <input type="button" class="document_handler_form_button_1" id="document_handler_form_file_button_refresh" name="document_handler_form_file_button_refresh" value="Refresh" onclick="refreshEntityFilePropertiesToFields()" />
