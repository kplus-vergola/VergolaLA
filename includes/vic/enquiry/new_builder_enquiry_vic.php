...
{ 
  ...
  $BuildName = mysql_escape_string($_POST['builder_name']);
  $BuildContact = mysql_escape_string($_POST['builder_contact']);          
  $BuildAddress1 = mysql_escape_string($_POST['baddress1']);
  $BuildAddress2 = mysql_escape_string($_POST['baddress2']);
  $BuildSuburb = mysql_escape_string($_POST['builder_suburb']) ;
  $BuildState = mysql_escape_string($_POST['builder_state']);          
  ...
  //$headers2 .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
    ...
    // error_log("TO: ".$to. " FROM: ".$from. " Subject: ".$subject. "message: " .$message." header: ".$headers, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log'); 
...
{ 
  ...
  $sql = "SELECT *, DATE_FORMAT(datelodged,'" . SQL_DATE_FORMAT_01 . "') fdatelodged, DATE_FORMAT(appointmentdate,'" . SQL_DATETIME_FORMAT_01 . "') fappointmentdate  FROM ver_chronoforms_data_builderpersonal_vic WHERE pid={$pid} ";
...
?>            
        ...
        <label class='input'><span><?php if($is_edit==0 || /*empty($LeadID)*/empty($leadname)){echo 'Lead Source'; } ?></span>
