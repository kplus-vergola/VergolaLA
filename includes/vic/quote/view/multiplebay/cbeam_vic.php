<?php
//error_log("INSIDE cbeam_vic from multiple bay: ".$ReLen[0], 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log'); 
...
error_log("ReLen: ".$ReLen[0], 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
// Length or Width
