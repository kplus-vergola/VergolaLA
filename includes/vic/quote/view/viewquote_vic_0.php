...
//error_log(print_r($retrieveff,true), 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log'); 
...
//error_log("VergolaType 1:".$Framework, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log'); 
$QuoteID = $retrieveff['quoteid'];
$quote_cf_id = $retrieveff['cf_id'];

//$is_builder=0;
//$is_builder = $retrieveff['is_builder'];
// error_log("QuoteID: ".$QuoteID, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
//  error_log(print_r($retrieveff,true), 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
// if(substr($QuoteID,0,3)=="BRV"){
// 	$is_builder = 1;
// 	//error_log('is builder', 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
// }
...
//error_log("RetStatus: ".$RetStatus, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
?>
...
<?php
	//error_log("c1", 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
?>
...
$(document).ready(function() {  
	...
	<?php 
		//error_log(" VergolaType 2: ".$VergolaType, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log'); 
		//error_log("PROJECTID IN view quote: ".$ProjectID, 3,'/home/vergola/public_html/quote-system/my-error.log'); 
		//error_log("Framework: ".$Framework." VergolaType:".$VergolaType, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
		...
		<?php
	  	...
	  	?>	
	  		//$('#output').html('<?php  //require "view_doublebay_vic_vr2.php"; ?>');
	  		<?php if(METRIC_SYSTEM=="inch"){ ?>
		...
		<?php
	  	}else if ($VergolaType == 'Double Bay VR4'  || $VergolaType == 'Double Bay VR4 - Drop-In') { 
	  		
	  	?>	
	  		   
	  		$('#output').html('<?php  require "view_doublebay_vic_vr4.php"; ?>');
			$.getScript('<?php echo JURI::base().'jscript/doublebay_vr2.js'; ?>');
...
//error_log("SELECT * FROM ver_chronoforms_data_measurement_vic WHERE projectid  = '$ProjectID'", 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
...
$ReWid = null;
$_ReWid = null;
//error_log("vergola type: ".$VergolaType, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
...
if($VergolaType == "Double Bay" || $VergolaType == "Double Bay - Drop-In" || $VergolaType == "Double Bay VR2" || $VergolaType == "Double Bay VR3" || $VergolaType == "Double Bay VR3 - Gutter" || $VergolaType == "Double Bay VR2 - Drop-In" || $VergolaType == "Double Bay VR3 - Drop-In" || $VergolaType == "Double Bay VR3 - Gutter - Drop-In"  ){
	...
	//error_log("AM HERE 1!", 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log'); 
	//error_log("L1: ".$ReLen[0]. " L2: ".$ReLen[1]." W:".$_ReWid, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');	
}else if($VergolaType == "Multiple Bay" || $VergolaType == "Multiple Bay - Drop-In" || $VergolaType == "Double Bay VR4" || $VergolaType == "Double Bay VR4 - Drop-In"){
	$k=0; 
	while ($retrievem = mysql_fetch_array($resultm)){
		$ReLen[$k] = $retrievem['length'];
		$ReWid[$k] = $retrievem['width']; 
		$k++;
		//error_log(print_r($retrievem['length'],true), 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
		//error_log(print_r($retrievem['width'],true), 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log'); 

	}	
	$numBay = $k; 
	//error_log("AM HERE 2!", 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log'); 
}else{
...
//error_log(print_r($quote,true), 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
...
//error_log("outside: ".print_r($colours,true), 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
...
<div id="project" class="<?php echo ($is_create_duplicate==1?'duplicating-fields':'') ?>">
	...
	<span class="quoteinfo"><label>Type Of Vergola</label><input type="text" id="framework" name="framework"  value="<?php echo $VergolaType; ?>"  readonly="readonly" style="width:150px" /></span>
	...
	<div id="frameset"> 
	 	...
	 	<?php if($VergolaType == 'Single Bay VR1' || $VergolaType == 'Single Bay VR1 - Drop-In' ) { ?>
			<?php if(METRIC_SYSTEM=="inch"){ error_log("ReWid: ".$ReWid." get_feet_whole: ".get_feet_whole($ReWid)." get_feet_inch: ".get_feet_inch($ReWid), 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');  ?>
		...
		<?php }else if($VergolaType == 'Double Bay VR4' || $VergolaType == 'Double Bay VR4 - Drop-In' ) { ?>
			<span  class="quoteinfo"><label>Bay</label><input  type="text" value="<?php echo $numBay; ?>" name="dblength[]" id="dbbay" class="num" autocomplete="off" /></span>
			 
			<span   class="quoteinfo quote-length"><label>Length</label>
				<?php
					for($k=0;$k<$numBay;$k++){
				?>
					<input type="text" value="<?php echo $ReLen[$k]; ?>" name="dblength[]" id="lbay<?php echo $k+1; ?>" class="lbay num" style="display:block; " autocomplete="off" /> 
				<?php } ?>

			</span>
			<span   class="quoteinfo"><label>Width</label><input type="text" value="<?php echo $ReWid[0]; ?>" name="dbwidth[]"  id="dbwidthid1"   class="_width num" autocomplete="off" /></span>
	...
	<span>
		...
		<!-- <input type="hidden" name="is_builder" id="" value=" " /> -->
	</span>
</div>
...
<div class="table-subtotal-holder" style="display:none">
	...
	<tbody>
		...
		<tr><td>Vergola  </td><td><span style="margin-right:10px;">$</span><input type="text" class="" value="" id="total_vergola" name="total_vergola" readonly="readonly" /></td></tr>
		<tr><td>Disbursement </td><td><span style="margin-right:10px;">$</span><input type="text" class="" value="" id="total_disbursement" name="total_disbursement"  readonly="readonly" /></td></tr>
		<tr><td>Sub Total </td><td><span style="margin-right:10px;">$</span><input type="text" class="" value="" id="sub_total" name="sub_total" readonly="readonly"/></td></tr>
		<tr><td><?php if(HOST_SERVER=="LA"){echo "";}else{echo "GST";} ?>  </td><td><span style="margin-right:10px;">$</span><input type="text" class="" value="<?php echo (isset($RetTotalGST)) ? $RetTotalGST : ''; ?>" id="total_gst" name="total_gst" /></td></tr>
		<tr class="tr-total"><td>Total </td><td><span style="margin-right:10px;">$</span><input type="text" class="" value="" id="total_sum" name="total_sum" readonly="readonly" /> <input type="hidden" class="" value="" id="total_rrp" name="total_rrp" /> </td></tr> 
	</tbody>
	</table>
</div>
...
function listItem($framework_type,$item=null,$category=null,$itemId=""){
	...
	if($framework_type=="frame"){
		...
		//error_log("SELECT * FROM  {$inventory_table}  WHERE  LOWER(section) = '{$framework_type}' AND LOWER(category) = '{$category}'", 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
...
function listColours($selected=null,$item=null,$class=""){  
	...
	//error_log("listColours ".$resultcolour, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
	//error_log("listColours  :".print_r($item,true), 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
	$r = "<select class=\"{$class} \" name=\"colour[]\" >";
	//while ($colour = mysql_fetch_assoc($resultcolour)){ 
	foreach  ($colours as $c) 
	{
		$r .= "<option value=\"{$c}\" ";
		//error_log($colour['colour'] .'=' . $item['colour'], 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
		if ($c == $item['colour']) { $r .= " selected ";} 
		else { 
			$r .= "";
		}
		$r .= ">{$c}</option>";
...
function listColourBond2($selected=null,$item,$section="Frame"){  
    ...
    while ($paint = mysql_fetch_array($paints)){
    	//if($item["inventoryid"]=="IRV55")
    		//error_log("invID: ".$item['finish']."list color :".$paint['description']." item color: ".$item['finish'], 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
...
function generateHtmlReport($projectid,$title){ 
	...
	if($VergolaType == "Double Bay" || $VergolaType == "Double Bay - Drop-In" || $VergolaType == "Double Bay VR2" || $VergolaType == "Double Bay VR3" || $VergolaType == "Double Bay VR3 - Gutter" || $VergolaType == "Double Bay VR2 - Drop-In" || $VergolaType == "Double Bay VR3 - Drop-In" || $VergolaType == "Double Bay VR3 - Gutter - Drop-In"  ){
		...
		while ($retrievem = mysql_fetch_array($resultm)){
			...
			$k++;
			//error_log(print_r($ReLen,true), 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log'); 
		}	
		$numBay = 2;
		...
		if(METRIC_SYSTEM=="meter"){
			...
			//error_log("ReLen: ".html_entity_decode($ReLen), 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log'); 
			//error_log("ReWid: ".html_entity_decode($ReWid), 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log'); 
		}
...
//error_log($html, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log'); 	
return $html;
