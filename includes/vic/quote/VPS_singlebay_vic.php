...
//error_log("cbeam200 :".$cbeam200['cf_id']. " ----- cbeam200ID: ".$cbeam200ID, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
...
echo "<tr><td><select class=\"desclist\" name=\"desclist[]\" >"; 
		...
		while ($cbeam200 = mysql_fetch_assoc($resultcbeam200)) {
			//error_log(print_r(mysql_fetch_array($resultcbeam200),true), 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log'); 	
			//error_log("cbeam200 :".$cbeam200['cf_id']. " == cbeam200ID: ".$cbeam200ID, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
