    ...
    if ($api_data['vr_form_items_data_entry']['bom_form_item_dimensions_info']['item_dimension_record_index'] != '') {
        ...
        $sql = str_replace(
            array(
                ...
                '[DIMENSION_F_FRACTION]', '[DIMENSION_G_INCH]',
                '[DIMENSION_G_FRACTION]', '[DIMENSION_H_INCH]',                 
                '[DIMENSION_H_FRACTION]', '[DIMENSION_P_INCH]', 
            ...
            array(
                ...
                addslashes($api_data['vr_form_items_data_entry']['bom_form_item_dimensions_info']['item_dimension_g_inch']), 
                addslashes($api_data['vr_form_items_data_entry']['bom_form_item_dimensions_info']['item_dimension_g_fraction']),
                addslashes($api_data['vr_form_items_data_entry']['bom_form_item_dimensions_info']['item_dimension_h_inch']), 
                addslashes($api_data['vr_form_items_data_entry']['bom_form_item_dimensions_info']['item_dimension_h_fraction']),
