    ...
    if ($results['error'] == 'null') {
        while ($r1 = mysql_fetch_array($results['data'])) {
            ...
            $vr_item_default_dimensions_list[$r1['inventoryid']] = array(
                ...
                'item_dimension_g_inch' => $r1['dimension_g_inch'], 
                'item_dimension_g_fraction' => $r1['dimension_g_fraction'], 
                'item_dimension_h_inch' => $r1['dimension_h_inch'], 
                'item_dimension_h_fraction' => $r1['dimension_h_fraction'], 
