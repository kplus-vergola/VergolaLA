...
function generateRowItemVR3G($section, $fw=null){ //type = double bay vr2, double bay vr3, double bay vr2 - gutter
	...
	if($section=="frame"){
		...
		while ($r = mysql_fetch_assoc($framework)) {
	 	...
	 	$framework = mysql_query("SELECT * FROM ver_vergola_default_framework_items   WHERE  framework = 'Double Bay VR3' AND LOWER(section) = 'flashings'  ORDER BY field(inventoryid,'IRV43','IRV44','IRV45','IRV46','IRV47') " ); // 
