...
if(isset($_POST['contract'])){
	...
	// echo "<tr><td>
	// <span class=\"ffinfo\" data-link-field=\"appointmentdate\">
	// 	<label>Appointment Date</label>
	// 	<input type=\"text\" id=\"iappointment\" name=\"iappointment\" class=\"form-control date form_datetime\" data-date-format=\"JS_DFORMAT @ HH:ii P\" value=\"$formatteddate\" readonly>
	// 	<input hidden type=\"text\" value=\"".$appointmentdate."\" name=\"appointmentdate\" id=\"appointmentdate\" autocomplete=\"off\" readonly=\"readonly\" />
	// </span>";
	?>
