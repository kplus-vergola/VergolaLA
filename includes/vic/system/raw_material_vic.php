...
if(isset($user->groups['10']) || isset($user->groups['26'])){ //only admin group=10 and group=26(office user) are allowed to modify.
}else{
...
if(isset($_REQUEST['cf_id']) || isset($cf_id)){
  ...
  $is_adding = 0;
  //error_log($_REQUEST['cf_id'], 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
  ...
  if (!$result) 
    ...
    //error_log(print_r($retrieve,true), 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
    // Inventory Details
