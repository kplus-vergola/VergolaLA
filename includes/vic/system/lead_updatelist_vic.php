...
{
	// $sel_year = $("#cbo_year").children("option:selected").val();
	// $market_year2 = $("#cbo_year").children("option:selected").val();
	// var market_year1 = $("#cbo_year").children("option:selected").val();
