...
{	
	...
	mysql_query("UPDATE ver_chronoforms_data_installer_vic SET name ='$name', mobile='$mobile', email='$email', block='$block' WHERE cf_id = '$id'")
				or die(mysql_error()); 
	echo "Saved!";
...
<table class="update-table">
	...
	<tr>
		...
		<tr>
		<td class="row1">Block:</td>
		<td class="row2"><input type="text" name="block" value="<?php echo $installer['block']; ?>"/></td>
	</tr>
	<tr>
		<td class="row1">&nbsp;</td>
