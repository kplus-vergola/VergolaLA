...
if (!$resultm) {die("Error: Data not found..");}
	...
	while ($retrievem = mysql_fetch_array($resultm)){
		...
		//error_log("DOUBLE BAY ReLen[{$k}]: {$ReLen[$k]} ", 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');
		$k++;
	}	
	...
	$ReBay 	 = $retrievem['bay'];
	//error_log("ReLen:".$ReLen.", ReWid:".$ReWid.", ReBay:".$ReBay, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');	
}
...
//error_log("ReLen[0]:".$ReLen[0].", ReLen[1]:".$ReLen[1].", _ReWid:".$_ReWid, 3,'C:\\xampp\htdocs\\vergola_contract_system_v4_us\\my-error.log');	
	?>
