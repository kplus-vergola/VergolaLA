...
function generate_html_load_list($projectid){
  ...
  $sql = "SELECT * FROM ver_chronoforms_data_contract_list_vic AS contract 
      ...
      JOIN ver_chronoforms_data_contract_details_vic AS cd ON CONVERT (cd.projectid USING utf8 ) COLLATE utf8_general_ci = contract.projectid 
...
<tr>
  <td colspan="2" style="  vertical-align:top;" rowspan="2"  >    
    <span>Site:</span>'. addslashes($contract['site_streetno'].' '.$contract['site_streetname'].' '.$contract['site_address']).'
  </td>  
