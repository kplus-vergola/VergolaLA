					...
					<?php 
						if (JFactory::getUser()->get('guest')) {
							if(HOST_SERVER=="Victoria"){ 
						     ...
						     echo "<label style='border-top:3px; border-bottom:3px; color:#3F286D; font-size:2em;'>South Australia</label>";
							}else if(HOST_SERVER=="LA"){ 
						     echo "<label style='border-top:3px; border-bottom:3px; color:#3F286D; font-size:2em;'>Los Angeles</label>";
							}
 						}
