...
--
-- Table structure for table `tblvrformitemsconfig`
--

CREATE TABLE IF NOT EXISTS `tblvrformitemsconfig` (
`id` int(11) NOT NULL,
  `vr_type_ref_name` varchar(255) DEFAULT NULL,
  `vr_type_display_name` varchar(255) DEFAULT NULL,
  `vr_section_ref_name` varchar(255) DEFAULT NULL,
  `vr_section_display_name` varchar(255) DEFAULT NULL,
  `vr_subsection_ref_name` varchar(255) DEFAULT NULL,
  `vr_subsection_display_name` varchar(255) DEFAULT NULL,
  `vr_item_ref_name` varchar(255) DEFAULT NULL,
  `vr_item_display_name` varchar(255) DEFAULT NULL,
  `vr_item_display_name_input_type` varchar(50) DEFAULT NULL,
  `vr_item_webbing` varchar(255) DEFAULT NULL,
  `vr_item_webbing_input_type` varchar(50) DEFAULT NULL,
  `vr_item_colour` varchar(255) DEFAULT NULL,
  `vr_item_colour_input_type` varchar(50) DEFAULT NULL,
  `vr_item_finish` varchar(255) DEFAULT NULL,
  `vr_item_finish_input_type` varchar(50) DEFAULT NULL,
  `vr_item_uom` varchar(255) DEFAULT NULL,
  `vr_item_uom_input_type` varchar(50) DEFAULT NULL,
  `vr_item_unit_price` float DEFAULT NULL,
  `vr_item_unit_price_input_type` varchar(50) DEFAULT NULL,
  `vr_item_qty` int(11) DEFAULT NULL,
  `vr_item_qty_input_type` varchar(50) DEFAULT NULL,
  `vr_item_length_feet` int(11) DEFAULT NULL,
  `vr_item_length_feet_input_type` varchar(50) DEFAULT NULL,
  `vr_item_length_inch` int(11) DEFAULT NULL,
  `vr_item_length_inch_input_type` varchar(50) DEFAULT NULL,
  `vr_item_length_fraction` varchar(255) DEFAULT NULL,
  `vr_item_length_fraction_input_type` varchar(50) DEFAULT NULL,
  `vr_item_rrp` float DEFAULT NULL,
  `vr_item_rrp_input_type` varchar(50) DEFAULT NULL,
  `vr_item_image` varchar(255) DEFAULT NULL,
  `vr_item_image_input_type` varchar(50) DEFAULT NULL,
  `vr_item_config_internal_ref_name` varchar(255) DEFAULT NULL,
  `vr_item_adhoc` varchar(50) DEFAULT NULL,
  `vr_record_index` int(11) DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='status = WON if it has a contract signed';
...
`cf_id` int(11) NOT NULL,
  ...
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `variation_amount` float NOT NULL DEFAULT '0',
  `variation_date` datetime DEFAULT NULL,
  `ver_chronoforms_data_contract_details_viccol` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL
...
`id` int(11) NOT NULL,
  ...
  `dimension_a_feet` decimal(19,2) DEFAULT NULL,
  `dimension_a_inch` decimal(19,2) DEFAULT NULL,
  `dimension_a_fraction` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `dimension_b_feet` decimal(19,2) DEFAULT NULL,
  `dimension_b_inch` decimal(19,2) DEFAULT NULL,
  `dimension_b_fraction` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `dimension_c_feet` decimal(19,2) DEFAULT NULL,
  `dimension_c_inch` decimal(19,2) DEFAULT NULL,
  `dimension_c_fraction` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `dimension_d_feet` decimal(19,2) DEFAULT NULL,
  `dimension_d_inch` decimal(19,2) DEFAULT NULL,
  `dimension_d_fraction` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `dimension_e_feet` decimal(19,2) DEFAULT NULL,
  `dimension_e_inch` decimal(19,2) DEFAULT NULL,
  `dimension_e_fraction` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `dimension_f_feet` decimal(19,2) DEFAULT NULL,
  `dimension_f_inch` decimal(19,2) DEFAULT NULL,
  `dimension_f_fraction` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `dimension_p_feet` decimal(19,2) DEFAULT NULL,
  `dimension_p_inch` decimal(19,2) DEFAULT NULL,
  `dimension_p_fraction` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL
...
`cf_id` int(11) NOT NULL,
  ...
  `customisation_options` varchar(2000) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
`cf_id` int(11) NOT NULL,
  ...
  `type` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `order` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=36959 DEFAULT CHARSET=latin1 COMMENT='quote_no = QuoteID (Old System DB Table) quoteid name is already used in new system db table\nquote_qno = QCostID  (Old System DB Table)';
...
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=latin1 COMMENT=' is_builder is a column to determine if the quote was for a builder use in sales report.';
...
`cf_id` int(11) NOT NULL,
  ...
  `m_o_d` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT 'No',
  ...
  `citypermit_application_date` datetime DEFAULT NULL,
  `citypermit_application_approved_date` datetime DEFAULT NULL,
  `sitespec_engr_date` datetime DEFAULT NULL,
  `sitespec_engr_approved_date` datetime DEFAULT NULL,
  `strata_date` datetime DEFAULT NULL,
  `strata_approved_date` datetime DEFAULT NULL,
  `coastal_date` datetime DEFAULT NULL,
  `coastal_approved_date` datetime DEFAULT NULL,
  `engr_active` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT 'No',
  `strata_active` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT 'No',
  `coastal_active` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT 'No'
...
`cf_id` int(11) NOT NULL,
  ...
  `variation` decimal(19,2) DEFAULT '0.00',
  `customisation_options` varchar(2000) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `length_feet` decimal(19,2) DEFAULT NULL,
  `length_inch` decimal(19,2) DEFAULT NULL,
  `length_fraction` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `ver_chronoforms_data_inventory_vic_inch`
--

CREATE TABLE IF NOT EXISTS `ver_chronoforms_data_inventory_vic_inch` (
`cf_id` int(11) NOT NULL,
  `inventoryid` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `section` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `category` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `ver_chronoforms_data_inventory_vic_meter`
--

CREATE TABLE IF NOT EXISTS `ver_chronoforms_data_inventory_vic_meter` (
`cf_id` int(11) NOT NULL,
  `inventoryid` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `section` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `category` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `ver_chronoforms_data_material_default_supplier_vic`
--

CREATE TABLE IF NOT EXISTS `ver_chronoforms_data_material_default_supplier_vic` (
`cf_id` int(11) NOT NULL,
  `supplierid` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `inventoryid` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `materialid` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL
...
--
-- Table structure for table `ver_chronoforms_data_material_supplier_vic`
--

CREATE TABLE IF NOT EXISTS `ver_chronoforms_data_material_supplier_vic` (
`cf_id` int(11) NOT NULL,
  `supplierid` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `inventoryid` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `materialid` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
`cf_id` int(11) NOT NULL,
  ...
  `length_feet` decimal(19,2) DEFAULT NULL,
  `length_inch` decimal(19,2) DEFAULT NULL,
  `length_fraction` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `width_feet` decimal(19,2) DEFAULT NULL,
  `width_inch` decimal(19,2) DEFAULT NULL,
...
`cf_id` int(11) NOT NULL,
  ...
  `ver_chronoforms_data_pics_viccol` varchar(45) DEFAULT 'pic',
...
`cf_id` int(11) NOT NULL,
  ...
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='supplier_id = supplier id for new system\nsupplierid = supplier id from old system';
...
`cf_id` int(11) NOT NULL,
  ...
  `section_display_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `section_display_order` smallint(6) DEFAULT '0',
  `subsection_display_order` smallint(6) DEFAULT '0'
...
--
-- Table structure for table `ver_chronoforms_data_suburbs_vic_ca`
--

CREATE TABLE IF NOT EXISTS `ver_chronoforms_data_suburbs_vic_ca` (
`cf_id` int(11) NOT NULL,
  `suburb` varchar(10) DEFAULT NULL,
  `suburb_state` varchar(45) DEFAULT NULL,
...
--
-- Table structure for table `ver_chronoforms_data_suburbs_vic_la`
--

CREATE TABLE IF NOT EXISTS `ver_chronoforms_data_suburbs_vic_la` (
`cf_id` int(11) NOT NULL,
  `suburb` varchar(95) DEFAULT NULL,
  `suburb_state` varchar(45) DEFAULT NULL,
  `suburb_postcode` varchar(45) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
...
`id` int(11) NOT NULL,
  ...
  `target_contract` int(11) DEFAULT '0',
...
--
-- Table structure for table `ver_vergola_default_framework_items_old1`
--

CREATE TABLE IF NOT EXISTS `ver_vergola_default_framework_items_old1` (
`id` int(11) NOT NULL,
  `framework` varchar(150) DEFAULT NULL,
  `inventoryid` varchar(45) DEFAULT NULL,
  `qty` int(11) DEFAULT '1',
...
ALTER TABLE `tblsummarydailysalesquote`
 ADD PRIMARY KEY (`id`), ADD KEY `quote_date` (`quote_date`), ADD KEY `consultant_id` (`consultant_id`), ADD KEY `quote_id` (`quote_id`), ADD KEY `created_at` (`created_at`);
...
--
-- Indexes for table `tblvrformitemsconfig`
--
ALTER TABLE `tblvrformitemsconfig`
 ADD PRIMARY KEY (`id`), ADD KEY `vr_type_ref_name` (`vr_type_ref_name`), ADD KEY `vr_type_display_name` (`vr_type_display_name`), ADD KEY `vr_section_ref_name` (`vr_section_ref_name`), ADD KEY `vr_section_display_name` (`vr_section_display_name`), ADD KEY `vr_subsection_ref_name` (`vr_subsection_ref_name`), ADD KEY `vr_subsection_display_name` (`vr_subsection_display_name`), ADD KEY `vr_item_ref_name` (`vr_item_ref_name`), ADD KEY `vr_item_display_name` (`vr_item_display_name`), ADD KEY `vr_item_display_name_input_type` (`vr_item_display_name_input_type`), ADD KEY `vr_item_webbing` (`vr_item_webbing`), ADD KEY `vr_item_webbing_input_type` (`vr_item_webbing_input_type`), ADD KEY `vr_item_colour` (`vr_item_colour`), ADD KEY `vr_item_colour_input_type` (`vr_item_colour_input_type`), ADD KEY `vr_item_finish` (`vr_item_finish`), ADD KEY `vr_item_finish_input_type` (`vr_item_finish_input_type`), ADD KEY `vr_item_uom` (`vr_item_uom`), ADD KEY `vr_item_uom_input_type` (`vr_item_uom_input_type`), ADD KEY `vr_item_unit_price` (`vr_item_unit_price`), ADD KEY `vr_item_unit_price_input_type` (`vr_item_unit_price_input_type`), ADD KEY `vr_item_qty` (`vr_item_qty`), ADD KEY `vr_item_qty_input_type` (`vr_item_qty_input_type`), ADD KEY `vr_item_length_feet` (`vr_item_length_feet`), ADD KEY `vr_item_length_feet_input_type` (`vr_item_length_feet_input_type`), ADD KEY `vr_item_length_inch` (`vr_item_length_inch`), ADD KEY `vr_item_length_inch_input_type` (`vr_item_length_inch_input_type`), ADD KEY `vr_item_length_fraction` (`vr_item_length_fraction`), ADD KEY `vr_item_length_fraction_input_type` (`vr_item_length_fraction_input_type`), ADD KEY `vr_item_rrp` (`vr_item_rrp`), ADD KEY `vr_item_rrp_input_type` (`vr_item_rrp_input_type`), ADD KEY `vr_item_image` (`vr_item_image`), ADD KEY `vr_item_image_input_type` (`vr_item_image_input_type`), ADD KEY `vr_item_config_internal_ref_name` (`vr_item_config_internal_ref_name`), ADD KEY `vr_item_adhoc` (`vr_item_adhoc`), ADD KEY `vr_record_index` (`vr_record_index`), ADD KEY `display_order` (`display_order`), ADD KEY `status` (`status`);
...
--
-- Indexes for table `ver_chronoforms_data_inventory_vic_inch`
--
ALTER TABLE `ver_chronoforms_data_inventory_vic_inch`
 ADD PRIMARY KEY (`cf_id`), ADD UNIQUE KEY `inventoryid_UNIQUE` (`inventoryid`);

--
-- Indexes for table `ver_chronoforms_data_inventory_vic_meter`
--
ALTER TABLE `ver_chronoforms_data_inventory_vic_meter`
 ADD PRIMARY KEY (`cf_id`), ADD UNIQUE KEY `inventoryid_UNIQUE` (`inventoryid`);
...
--
-- Indexes for table `ver_chronoforms_data_material_default_supplier_vic`
--
ALTER TABLE `ver_chronoforms_data_material_default_supplier_vic`
 ADD PRIMARY KEY (`cf_id`);
...
--
-- Indexes for table `ver_chronoforms_data_material_supplier_vic`
--
ALTER TABLE `ver_chronoforms_data_material_supplier_vic`
 ADD PRIMARY KEY (`cf_id`);
...
--
-- Indexes for table `ver_chronoforms_data_suburbs_vic_ca`
--
ALTER TABLE `ver_chronoforms_data_suburbs_vic_ca`
 ADD PRIMARY KEY (`cf_id`);

--
-- Indexes for table `ver_chronoforms_data_suburbs_vic_la`
--
ALTER TABLE `ver_chronoforms_data_suburbs_vic_la`
 ADD PRIMARY KEY (`cf_id`);
...
--
-- Indexes for table `ver_vergola_default_framework_items_old1`
--
ALTER TABLE `ver_vergola_default_framework_items_old1`
 ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tblvrformitemsconfig`
--
ALTER TABLE `tblvrformitemsconfig`
...
--
ALTER TABLE `ver_chronoforms_data_contract_details_vic`
MODIFY `cf_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=48;
--
...
--
ALTER TABLE `ver_chronoforms_data_contract_items_vic_1`
MODIFY `cf_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=36959;
--
...
--
ALTER TABLE `ver_chronoforms_data_contract_statutory_vic`
MODIFY `cf_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=47;
--
...
--
ALTER TABLE `ver_chronoforms_data_drawings_vic`
MODIFY `cf_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=28;
--
...
--
ALTER TABLE `ver_chronoforms_data_inventory_vic`
MODIFY `cf_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=506;
--
-- AUTO_INCREMENT for table `ver_chronoforms_data_inventory_vic_inch`
--
ALTER TABLE `ver_chronoforms_data_inventory_vic_inch`
MODIFY `cf_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=268;
--
-- AUTO_INCREMENT for table `ver_chronoforms_data_inventory_vic_meter`
--
ALTER TABLE `ver_chronoforms_data_inventory_vic_meter`
MODIFY `cf_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=280;
--
...
--
ALTER TABLE `ver_chronoforms_data_materials_vic`
MODIFY `cf_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=173;
--
-- AUTO_INCREMENT for table `ver_chronoforms_data_material_default_supplier_vic`
--
ALTER TABLE `ver_chronoforms_data_material_default_supplier_vic`
...
MODIFY `cf_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=151;
--
-- AUTO_INCREMENT for table `ver_chronoforms_data_material_supplier_vic`
--
ALTER TABLE `ver_chronoforms_data_material_supplier_vic`
MODIFY `cf_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1211;
--
...
--
ALTER TABLE `ver_chronoforms_data_notes_vic`
MODIFY `cf_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=562;
--
-- AUTO_INCREMENT for table `ver_chronoforms_data_pics_vic`
--
ALTER TABLE `ver_chronoforms_data_pics_vic`
MODIFY `cf_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=50;
--
...
--
ALTER TABLE `ver_chronoforms_data_suburbs_vic`
MODIFY `cf_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4206;
--
-- AUTO_INCREMENT for table `ver_chronoforms_data_suburbs_vic_ca`
--
ALTER TABLE `ver_chronoforms_data_suburbs_vic_ca`
MODIFY `cf_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ver_chronoforms_data_suburbs_vic_la`
--
ALTER TABLE `ver_chronoforms_data_suburbs_vic_la`
MODIFY `cf_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=97;
--
...
--
ALTER TABLE `ver_chronoforms_data_supplier_vic`
MODIFY `cf_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
...
--
-- AUTO_INCREMENT for table `ver_vergola_default_framework_items_old1`
--
ALTER TABLE `ver_vergola_default_framework_items_old1`
